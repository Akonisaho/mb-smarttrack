          ...
          <div style={C.main}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:10,marginBottom:14}}>
              <div style={C.stat(false,false)}>
                ...
                <div style={{fontSize:10,color:'#444'}}>{toHm(firmBillSec)} billable · {pct(firmBillSec,firmTotalSec)}% utilisation</div>
              </div>
              <div style={C.stat(true,false)}>
                ...
                <div style={{fontSize:24,fontWeight:800,color:'#6CC04A',marginBottom:4}}>R{(billedRevenue*1.15).toLocaleString()}</div>
          ...
          <div style={C.main}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:10,marginBottom:14}}>
              {[
                ...
                {l:'Total Billed',v:`R${(billedRevenue*1.15).toLocaleString()}`,s:`${billedUnits} units · incl. VAT`},
                ...
                <tbody>
                  ...
                  {filtInvoices.length>0&&(
                    <tr style={{background:'rgba(108,192,74,0.05)'}}>
                      ...
                      <td style={{...C.td,fontFamily:'monospace',fontWeight:700,color:'#6CC04A'}}>R{Math.round(billedRevenue*1.15).toLocaleString()}</td>
                    </tr>
                  )}
                </tbody>
              </table>
