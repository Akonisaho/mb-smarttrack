    ...
    <>
      ...
      <div style={C.page}>
        ...
        {tab==='trust'&&(<div style={C.main}>
          ...
          {trustTab==='receipt'&&(<div style={{display:'grid',gridTemplateColumns:isMobile?'1fr':'1fr 1fr',gap:16}}>
          ...
          {trustTab==='payment'&&(<div style={{display:'grid',gridTemplateColumns:isMobile?'1fr':'1fr 1fr',gap:16}}>
          ...
          {trustTab==='transfer'&&(<div style={{display:'grid',gridTemplateColumns:isMobile?'1fr':'1fr 1fr',gap:16}}>
