        ...
        <div style={S.logo}>
          <div style={{display:'flex',flexDirection:'column',gap:2}}>
            <div style={{display:'flex',alignItems:'center',gap:8}}>
              <img src={firm.logo_url || '/logo.png'} alt="MB" style={{height:22,width:'auto',objectFit:'contain',flexShrink:0,mixBlendMode:'screen'}} onError={e=>{e.target.style.display='none';e.target.insertAdjacentHTML('afterend','<div style="height:22px;padding:0 6px;background:#8DC63F;border-radius:4px;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:12px;color:#0A0A0A;flex-shrink:0">MB</div>');}}/>
